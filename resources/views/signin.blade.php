  ...
  <div class="o-formAuth__section">
    <div class="o-formAuth__wrapper">
      ...
      <div class="o-formAuth__header">
        ...
        <span class="o-formAuth__description">Continue with MEMMA</span>
      </div>
      <div class="o-formAuth__body">
        <div class="o-formAuth__form">
          ...
          <div class="o-formAuth__formGroup">
            <button id="submitButton" class="btn btn-primary">Sign In</button>
            <div style="margin-bottom: 8px;"></div>
            <button id="secondBtn" class="btn btn-default btn-light" style="color:rgba(0,0,0,0.5)">Create New Account</button>
          </div>
        </div>
      </div>
      ...
      <div class="o-formAuth__footer">
        ...
        <div class="o-formAuth__formGroup" style="margin: 0">
          ...
          <button class="btn btn-default btn-light" style="color:rgba(0,0,0,0.5)">Login With Google</button>
        </div>
      </div>
    </div>
  </div>
    ...
    (function () {
      ...
      let Memma = {
        ...
        onSubmit: function (event) {
          ...
          xhr.open('post', '/api/memma/v1/user/signin', true);
        ...
        handleSecondButton: function () {
          this.secondBtn.onclick = function(){
            var url = `${window.location.origin}/signup?appKey=${appKey}&credential=${credential}&redirectUrl=${redirectUrl}&type=${type}`;
